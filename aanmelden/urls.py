...
urlpatterns = [
    ...
    path(
        "set_opens_djo/<str:day>/<str:pod>/<str:opens_djo>",
        views.SetOpensDJO.as_view(),
        name="toggle_opens_djo",
    ),
    ...
    path(
        "api/v1/set_opens_djo/<str:day>/<str:pod>/<str:opens_djo>",
        api.SetOpensDJO.as_view(),
    ),
